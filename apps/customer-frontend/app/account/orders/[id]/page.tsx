...
export default function OrderDetailPage() {
  ...
  async function cancelOrder() { setCancelling(true); setMessage(""); try { setOrder(await customerRequest<any>(`/orders/${params.id}/cancel`, { method: "POST", body: JSON.stringify({ reason: "Cancelled by customer" }) })); setMessage("Order cancelled"); } catch (error: any) { setMessage(error.message); } finally { setCancelling(false); } }
