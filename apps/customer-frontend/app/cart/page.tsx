...
export default function CartPage() {
  ...
  async function applyCoupon(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!code) return;
    try { setCart(await customerRequest<Cart>("/cart/apply-coupon", { method: "POST", body: JSON.stringify({ code }) })); setMessage("Coupon applied"); } catch (error: any) { setMessage(error.message); }
  }
