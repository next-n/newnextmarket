...
export default function ProductVariantsPage() {
  ...
  async function save(event: FormEvent) {
    ...
    try {
      ...
      if (editingId) await apiClient.patch(API_ENDPOINTS.variant(editingId), body);
      else await apiClient.post(API_ENDPOINTS.productVariants(productId), body);
